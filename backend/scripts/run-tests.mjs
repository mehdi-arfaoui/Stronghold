...
const unitBase = [
  ...
  'tests/discoveryEnrichers.azureBlob.test.ts',
  'tests/discoveryEnrichers.orchestrator.test.ts',
  ...
  'tests/financialPricingHealthRoutes.test.ts',
  'tests/graphBridge.awsClassifications.test.ts',
  'tests/graphServiceIdentification.test.ts',
  'tests/helpers.test.js',
  'tests/jsonConfigValidation.test.ts',
  'tests/landingZoneFinancialContext.profileFlags.test.ts',
  ...
  'tests/serviceIdentity.service.test.ts',
